...
<head>
	...
	<link rel="stylesheet" href="<?=assets_url()?>demo-panel/style-switcher.css">
	<!-- GOOGLE FONTS -->
	<link href="https://fonts.googleapis.com/css?family=Source+Sans+Pro:300,400,600,700" rel="stylesheet">
	<!-- ICONS -->
	<link rel="apple-touch-icon" sizes="76x76" href="<?=assets_url()?>img/wakatobi2.png">
	<link rel="icon" type="image/png" sizes="96x96" href="<?=assets_url()?>img/wakatobi2.png">
</head>
